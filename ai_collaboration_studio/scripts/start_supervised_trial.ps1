...
try {
    ...
    $trialEnvironment = @{
        ...
        AI_STUDIO_DISABLED_PROVIDERS = 'openai,deepseek,doubao,qwen,glm'
        FUTU_HOST = '127.0.0.1'
        FUTU_PORT = '1'
        PYTHONUTF8 = '1'
    ...
    $clearNames = @('AI_STUDIO_SOURCE_MONITOR_CATCH_UP_MAX_ITEMS', 'AI_STUDIO_SOURCE_MONITOR_INITIAL_PREVIEW_SHA256',
        ...
        'OPENAI_API_KEY', 'DEEPSEEK_API_KEY', 'QWEN_API_KEY', 'DASHSCOPE_API_KEY', 'ARK_API_KEY', 'DOUBAO_API_KEY', 'GLM_API_KEY', 'ZHIPU_API_KEY', 'ZHIPUAI_API_KEY',
